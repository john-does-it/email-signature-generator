    ...
    <form-and-title-container>
      <form>
        ...
        <fieldset>
          ...
          <label for="fontSize">
            Taille de la police
            <input name="fontSize" type="number" bind:value={fontSize}>
          </label>
        </fieldset>
        <fieldset>
    ...
    <table-and-title-container>
      ...
      <table style="line-height: 1.2;">
        <thead>
          ...
          <tr>
            <td>
              <span style="font-size: 14px; font-family: 'Calibri', sans-serif; text-transform: capitalize; font-weight: bold;">
                 {companyName}
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td>
              ...
              <span style="font-size: 14px; font-family: 'Calibri', sans-serif;">
                <span style="color: #E84E0F; font-weight: bold; text-transform: capitalize;">T</span>
              ...
              <span style="font-size: 14px; font-family: 'Calibri', sans-serif;">
                <span style="color: #E84E0F; font-weight: bold; text-transform: capitalize;">M</span>
          ...
          <tr>
            <td>
              ...
              <span style="font-size: 14px; font-family: 'Calibri', sans-serif;">
                <span style="color: #E84E0F; font-weight: bold;">E</span>
                <a href="mailto:{emailAddress}" title="Envoyer un email à {firstName} {lastName} via {emailAddress}">{emailAddress}</a>
              </span>
              {/if}
            </td>
          </tr>
          {/if}
          {/if}
          {#if facebookPageURL || instagramPageUrl || linkedinPageURL || youtubePageUrl || tiktokPageUrl || websiteURL}
            ...
            <td>
              <span style="font-size: 24px;">
                ...
                <a href="{facebookPageURL}" title="Accéder à la page Facebook de {companyName}">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" style="vertical-align: middle;">
                ...
                <a href="{tiktokPageUrl}" title="Accéder à la page TikTok de {companyName}">
                  <!-- <img src="logo-tiktok.png" alt="Logo de TikTok" style="vertical-align: middle; height: 24px;"> -->
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" style="vertical-align: middle;">
          ...
          <tr>
            <td style="vertical-align: middle;">
              {#if websiteURL}
              <a href="{websiteURL}" title="Accéder au site web de {companyName}" style="font-size: 14px; font-family: 'Calibri', sans-serif;">
                {websiteURL}
              </a>
              {/if}
            </td>
